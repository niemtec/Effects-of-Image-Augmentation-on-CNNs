...
with open("binary-animal-classifier-v1/classifier-network-v1.json", "w") as json_file:
    json_file.write(model_json)

# Serialise weights to HDF5
datestamp = datetime.datetime.now()
model.save_weights("binary-animal-classifier-v1/" + str(datestamp) + ".h5")  # always save your weights after training or during training
