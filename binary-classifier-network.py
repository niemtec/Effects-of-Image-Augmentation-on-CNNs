...
datasetName = 'control'
resultsFileName = 'noise-004-results'
modelName = 'noise-004-' + datasetName
datasetPath = home + '/home/Downloads/Project-Turing/datasets/image-corruption-dataset/cats-dogs-noise-004/'
